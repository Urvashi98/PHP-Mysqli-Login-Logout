...
// assigns session values to a variable.
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="jumbotron">
                        ...
                        <hr class="my-5">
                        <p>Hope you enjoyed this tutorial!! To get the entire code <a href="https://github.com/Urvashi98/PHP-Mysqli-Login-Logout">Press Here</a></p>
                        <p class="lead">
